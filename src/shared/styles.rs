...
script_mod! {
    ...
    mod.widgets.ICON_ADD_IMAGE       = crate_resource("self://resources/icons/add_image.svg")
    mod.widgets.ICON_LOCATION_PERSON = crate_resource("self://resources/icons/location-person.svg")
